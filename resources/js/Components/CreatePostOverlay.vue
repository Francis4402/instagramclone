            ...
            <div class="w-full md:flex h-[calc(100%-55px)] rounded-xl overflow-auto">
                ...
                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    ...
                    <div class="flex w-full max-h-[200px] bg-white border-b">
                        <textarea ref="textarea" v-model="form.text" placeholder="Write caption..." rows="10" class="placeholder-gray-500 w-full border-0 mt-2 mb-2 z-50 focus:ring-0 text-gray-600 text-[18px]"></textarea>
                    </div>
...
<script setup>
    ...
    const getUploadedImage = (e) => {
        ...
        if (extention == 'png' || extention == 'jpg' || extention == 'jpeg' || extention == 'webp') {
